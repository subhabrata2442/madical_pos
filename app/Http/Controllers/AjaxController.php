...
class AjaxController extends Controller {
	...
	public function ajaxpost_update_inward_stock($request) {
        ...
        public function ajaxpost_update_inward_stock_draft($request) {
            ...
            try {
                ...
                if($inward_stock['invoice_no']!=''){
                    ...
                    if($count>0){
                        ...
                        //echo '<pre>';print_r($purchaseStockData);exit;
                        $purchaseInwardStock	= PurchaseInwardStockDraft::where('id', $purchaseId)->update($purchaseStockData);
                        $purchaseInwardStockId	= $purchaseId;
                        //echo '<pre>';print_r($purchaseStockData);exit;

                        //$purchaseInwardStockId=2;

                        InwardStockProductsDraft::where('inward_stock_id', $purchaseInwardStockId)->delete();
