                        ...
                        <tbody id="sproduct_detail_record">
                           ...
                           <tr class="trborderbottom" id="RoleValues_{{$count}}">
                              <td bgcolor="#f3f3f3" class="leftAlign" id="submoduleid_{{$subRoll['roll_id']}}">
                                 {{$subRoll['title']}}
                                 <input type="hidden" name="employee_role_permission_id[{{$count}}][]" value="{{$subRoll['roll_id']}}">
                              </td>
                              <td class="center" onmouseover="checkboxOver({{$count}})"
                                 onmouseleave="checkboxleave({{$count}})" id="view_{{$subRoll['roll_id']}}">
                                 @if ($subRoll['is_view']=='N')
                                 <input type="checkbox" class="" name="" disabled="">
                                 @else
                                 <input type="checkbox" class="per_view_{{$count}}" name="view[{{$count}}][]" id="view_chk_{{$subRoll['roll_id']}}"
                                    onclick="indvCheck({{$subRoll['roll_id']}},{{$count}},0)" value="1">
                                 @endif
                              </td>
                              <td class="center" onmouseover="checkboxOver({{$count}})"
                                 onmouseleave="checkboxleave({{$count}})" id="add_{{$subRoll['roll_id']}}">
                                 @if ($subRoll['is_add']=='N')
                                 <input type="checkbox" class="" name="" disabled="">
                                 @else
                                 <input type="checkbox" class="per_add_{{$count}}" name="add[{{$count}}][]" id="add_chk_{{$subRoll['roll_id']}}" value="2">
                                 @endif
                              </td>
                              <td class="center" onmouseover="checkboxOver({{$count}})"
                                 onmouseleave="checkboxleave({{$count}})" id="edit_{{$subRoll['roll_id']}}">
                                 @if ($subRoll['is_edit']=='N')
                                 <input type="checkbox" class="" name="" disabled="">
                                 @else
                                 <input type="checkbox" class="per_edit_{{$count}}" name="edit[{{$count}}][]" id="edit_chk_{{$subRoll['roll_id']}}" value="3">
                                 @endif
                              </td>
                              <td class="center" onmouseover="checkboxOver({{$count}})"
                                 onmouseleave="checkboxleave({{$count}})" id="del_{{$subRoll['roll_id']}}">
                                 @if ($subRoll['is_delete']=='N')
                                 <input type="checkbox" class="" name="" disabled="">
                                 @else
                                 <input type="checkbox" class="per_delete_{{$count}}" name="delete[{{$count}}][]" id="del_chk_{{$subRoll['roll_id']}}" value="4">
                                 @endif

                              </td>
                              <td class="center" onmouseover="checkboxOver({{$count}})"
                                 onmouseleave="checkboxleave({{$count}})" id="exprt_{{$subRoll['roll_id']}}">
                                 @if ($subRoll['is_download']=='N')
                                 <input type="checkbox" class="" name="" disabled="">
                                 @else
                                 <input type="checkbox" class="per_export_{{$count}}" name="download[{{$count}}][]" id="export_chk_{{$subRoll['roll_id']}}" value="5">
                                 @endif

                              </td>
                              <td class="center" onmouseover="checkboxOver({{$count}})"
                                 onmouseleave="checkboxleave({{$count}})" id="print_{{$subRoll['roll_id']}}">
                                 @if ($subRoll['is_print']=='N')
                                 <input type="checkbox" class="" name="" disabled="">
                                 @else
                                 <input type="checkbox" class="per_print_{{$count}}" name="print[{{$count}}][]" id="print_chk_{{$subRoll['roll_id']}}" value="6">
                                 @endif

                              </td>
                              <td class="center" onmouseover="checkboxOver({{$count}})"
                                 onmouseleave="checkboxleave({{$count}})" id="upload_{{$subRoll['roll_id']}}">
                                 @if ($subRoll['is_upload']=='N')
                                 <input type="checkbox" class="" name="" disabled="">
                                 @else
                                 <input type="checkbox" class="per_upload_{{$count}}" name="upload[{{$count}}][]" id="upload_chk_{{$subRoll['roll_id']}}" value="7">
                                 @endif
