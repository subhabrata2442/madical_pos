...
<div id="site-main" class="site-main">
											...
											<div class="col-lg-4">
												<div class="checkout-step-inner">
													...
													<div class="deliver-footer mt-4">
														<button type="submit" class="button btn-dark go_back_btn" step="2"
															prevStep="1"> Go back</button>
	...
	<script>
		...
		function billing_shipping_html() {
			...
			<p>' + billing_company + '</p><p>' + billing_address_1 + '</p><p>' + billing_email + '</p><p>' + billing_phone + '</p><p>' + billing_city + '</p><p>' + billing_state + ', ' + billing_zipcode + '</p><p>' + billing_country + '</p>';

			shipping_html += '<p>' + shipping_first_name + ' ' + shipping_last_name + '</p>\
			<p>' + shipping_company + '</p><p>' + shipping_address_1 + '</p><p>' + shipping_email + '</p><p>' + shipping_city + '</p><p>' + shipping_state + ', ' + shipping_zipcode + '</p><p>' + shipping_country + '</p>';
		...
		$('.continue_btn').click(function() {
			...
			if (window["validateStep" + step]()) {
				...
				$('#step-' + step).removeClass('show active');
				$('#step-' + nextStep + '-tab').addClass('active');
