...
<div class="row">
  <div class="col-12">
    <div class="card">
      <form method="post" action="{{ route('admin.embloyees.edit', [base64_encode($data['store']->id)]) }}"
        class="needs-validation" id="user-form" novalidate enctype="multipart/form-data">
        @csrf
        <div class="row">
          <x-alert />
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control admin-input" id="full_name" name="full_name"
                value="{{ old('full_name', $data['store']->name) }}" required autocomplete="off">
              @error('full_name')
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control admin-input" id="Email" name="email"
                value="{{ old('email', $data['store']->email) }}" required autocomplete="off">
              @error('email')
              <div class="error">{{ $message }}</div>
              @enderror </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control admin-input" id="address" name="address"
                value="{{ old('phone', $data['store']->get_store_info->address) }}" required autocomplete="off">
              @error('address')
              <div class="error">{{ $message }}</div>
              @enderror </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control admin-input" id="phone" name="phone"
                value="{{ old('phone', $data['store']->phone) }}" required autocomplete="off">
              @error('phone')
              <div class="error">{{ $message }}</div>
              @enderror </div>
          </div>
                ...
                <tbody id="sproduct_detail_record">
                  ...
                  <tr class="trborderbottom" id="module_{{$count}}">
                    <td bgcolor="#f3f3f3" class="leftAlign" style="text-transform:uppercase;">
                      ...
                      <input type="checkbox" onclick="pagesCheck({{$count}})" name="roll_ids[{{$count}}]"
                        ...
                        <?php if($value['is_checked']=='Y'){ echo 'checked';} ?>>
                    </td>
                  ...
                  <tr class="trborderbottom" id="RoleValues_{{$count}}">
                    ...
                    <td class="center" onmouseover="checkboxOver({{$count}})" onmouseleave="checkboxleave({{$count}})"
                      ...
                      @else
                      <input type="checkbox" class="per_view_{{$count}}"
                        name="view[{{$count}}][{{$subRoll['roll_id']}}]" id="view_chk_{{$subRoll['roll_id']}}"
                        onclick="indvCheck({{$subRoll['roll_id']}},{{$count}},0)" value="1"
                        <?php if($subRoll['is_view_chk']=='Y'){ echo 'checked';} ?>>
                      @endif
                    </td>
                    <td class="center" onmouseover="checkboxOver({{$count}})" onmouseleave="checkboxleave({{$count}})"
                      ...
                      <input type="checkbox" class="per_add_{{$count}}" name="add[{{$count}}][{{$subRoll['roll_id']}}]"
                        id="add_chk_{{$subRoll['roll_id']}}" value="2"
                        <?php if($subRoll['is_add_chk']=='Y'){ echo 'checked';} ?>>
                      @endif
                    </td>
                    <td class="center" onmouseover="checkboxOver({{$count}})" onmouseleave="checkboxleave({{$count}})"
                      ...
                      <input type="checkbox" class="" name="" disabled="">
                      @else
                      <input type="checkbox" class="per_edit_{{$count}}"
                        name="edit[{{$count}}][{{$subRoll['roll_id']}}]" id="edit_chk_{{$subRoll['roll_id']}}" value="3"
                        <?php if($subRoll['is_edit_chk']=='Y'){ echo 'checked';} ?>>
                      @endif
                    </td>
                    <td class="center" onmouseover="checkboxOver({{$count}})" onmouseleave="checkboxleave({{$count}})"
                      ...
                      <input type="checkbox" class="" name="" disabled="">
                      @else
                      <input type="checkbox" class="per_delete_{{$count}}"
                        name="delete[{{$count}}][{{$subRoll['roll_id']}}]" id="del_chk_{{$subRoll['roll_id']}}"
                        value="4" <?php if($subRoll['is_delete_chk']=='Y'){ echo 'checked';} ?>>
                      @endif
                    ...
                    <td class="center" onmouseover="checkboxOver({{$count}})" onmouseleave="checkboxleave({{$count}})"
                      ...
                      <input type="checkbox" class="" name="" disabled="">
                      @else
                      <input type="checkbox" class="per_export_{{$count}}"
                        name="download[{{$count}}][{{$subRoll['roll_id']}}]" id="export_chk_{{$subRoll['roll_id']}}"
                        value="5" <?php if($subRoll['is_download_chk']=='Y'){ echo 'checked';} ?>>
                      @endif
                    ...
                    <td class="center" onmouseover="checkboxOver({{$count}})" onmouseleave="checkboxleave({{$count}})"
                      ...
                      <input type="checkbox" class="" name="" disabled="">
                      @else
                      <input type="checkbox" class="per_print_{{$count}}"
                        name="print[{{$count}}][{{$subRoll['roll_id']}}]" id="print_chk_{{$subRoll['roll_id']}}"
                        value="6" <?php if($subRoll['is_print_chk']=='Y'){ echo 'checked';} ?>>
                      @endif
                    ...
                    <td class="center" onmouseover="checkboxOver({{$count}})" onmouseleave="checkboxleave({{$count}})"
                      ...
                      <input type="checkbox" class="" name="" disabled="">
                      @else
                      <input type="checkbox" class="per_upload_{{$count}}"
                        name="upload[{{$count}}][{{$subRoll['roll_id']}}]" id="upload_chk_{{$subRoll['roll_id']}}"
                        value="7" <?php if($subRoll['is_upload_chk']=='Y'){ echo 'checked';} ?>>
                      @endif
