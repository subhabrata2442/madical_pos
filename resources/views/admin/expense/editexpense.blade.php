...
<div class="row">
  <div class="col-12">
    <form method="post" action="{{ route('admin.expense.expenseedit', [base64_encode($data['expances']->id)]) }}" class="needs-validation" novalidate enctype="multipart/form-data">
      @csrf
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="form-control form-inputtext" required>
                    ...
                    @foreach ($data['category'] as $key=>$item)
                        <option value="{{$item->id}}" @if($data['expances']->category_id==$item->id) selected @endif>{{$item->category_name}}</option>
                    @endforeach
                </select>
          ...
          <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" name="notes" id="notes" cols="5" rows="2">{{ $data['expances']->notes }}</textarea>
