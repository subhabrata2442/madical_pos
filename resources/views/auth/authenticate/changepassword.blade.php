...
<form method="post" action="{{ route('admin.auth.save_changepassword') }}" class="needs-validation" novalidate enctype="multipart/form-data">
  @csrf
  <div class="row">
    <div class="col-md-12">
      <div class="card">
          ...
          <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control admin-input" name="password" id="password" required>
                    @error('password')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control admin-input" name="password_confirmation" id="password_confirmation" required>
