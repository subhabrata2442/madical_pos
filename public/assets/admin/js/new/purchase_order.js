...
$(document).on("click", "#inwardStockSubmitBtm", function() {
    ...
    Swal.fire({
        ...
        denyButtonText: 'Save as purchase',
        customClass: {
          actions: 'my-actions',
...
$(document).on("click", "#inwardStockSubmitBtmUpdateDraft", function() {
    if (no_of_items <= 0) {
        toastr.error("Not Item Found!");
    }
    ...
    $.ajax({
        ...
        data: {
            inward_stock: inward_stock_info,
            action: "update_inward_stock_draft",
            _token: prop.csrf_token,
        },
        dataType: "json",
        xhr: function () {
